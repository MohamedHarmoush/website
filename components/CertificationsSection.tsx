          ...
          >
            <div className="flex flex-col md:flex-row md:justify-between md:items-start">
              <div className="flex-1">
                ...
                <p className="text-base text-text-secondary mb-1">{cert.issuer}</p>
                {cert.credentialId && (
                  <p className="text-sm text-text-secondary mt-1">Credential ID: <span className="font-mono">{cert.credentialId}</span></p>
                )}
              </div>
              <div className="text-sm text-text-secondary mt-2 md:mt-0">
                ...
                {cert.url && (
                  <a
                    ...
                    className="ml-2 text-yellow-primary hover:text-yellow-dark transition-colors font-medium"
                  >
                    Verify
                  </a>
                )}
